...
make -C ../src
echo "../src/btm est $K $A $W $alpha $beta $niter $save_step $dwid_pt $model_dir"
../src/btm est $K $A $W $alpha $beta $niter $save_step $dwid_pt $model_dir


## infer p(z|d) for each doc
echo "================ Infer P(z|d)==============="
echo "../src/btm inf sum_b $K $dwid_pt $model_dir"
../src/btm inf sum_b $K $A $dwid_pt $model_dir
